...
export default function ElegantPreview() {
  ...
  <div className="p-8 rounded-2xl bg-semantic-surface-card shadow-lg">
          ...
          <div className="mt-8 flex gap-3">
            <a href="/shop" className="inline-block bg-semantic-btn-cta hover:bg-semantic-btn-cta-hover text-white px-6 py-3 rounded-md shadow transition">Order now</a>
            <a href="/contact" className="inline-flex items-center gap-2 border border-semantic-accent-gold text-semantic-text-primary px-4 py-3 rounded-md">
